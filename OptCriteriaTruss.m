%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% 2D Truss Optimization code given by GK AnathaSuresh sir during ME260%%
%%% COde is updated to work for 3D trusses %%%%%%%%%%%%%%%%%%%%%%%%%%%%%5%
%%% by Gunturu Akhil sai Krishna Mouli and Jayhind chouhan  %%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clc;
clear all;
...
Amin = 0.15; % Minimum allowed cross-sectional area of truss member
Ve = Ae .* Le;
